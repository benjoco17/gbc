...
function iq_testimonials_form(){
	...
	$paragraph = '<p class="iq-testimonials-info">Please fill in the form below to submit your support message<br /><em>Required fields are marked *</em></p>';
	...
	if (isset($_POST['submit'])){ // check if form has been submitted
		...
		if (!count($formerrors)){
			...
			$to = $to['value'];
			$subject = "Farmer Support Message Added on ".$bloginfo;
			$body = "Name: ".$clientname."\n"
					."Email: ".$email."\n"
					."Location: ".$location."\n"
					."Support Message: ".stripcslashes($testimonial)."\n"
					."FB / TW URL : ".$website."\n"
			...
			$html .= "<p class=\"iq-testimonials-success\">Thanks for adding your message of support to our farmers.</p>";
		}
	...
	$html .= '><label for="website" id="iq-testimonials-label">FB / TW URL: ';
	...
	$html .= '><label for="testimonial" id="iq-testimonials-label">Support Message: *</label>
