...
<h2>IQ Messages Settings</h2>
<form method="post" action="" id="settingsform">
<div class="settings-section-box">
<h4>Widget Settings</h4>
<table class="form-table">
	<tr valign="top">
		<th scope="row"><label for="max_widget_testimonials"><span title="The maximum number of testimonials that should be displayed on the widget.">Max Number Of Messages Displayed</span></label></th>
	...
	<tr valign="top">
		<th scope="row"><label for="form_website"><span title="Fades and cycles through the testimonials. Featured testimonials will show up first. Enabling this will override the max number of testimonials displayed.">Dynamically Rotate Messages</span></label></th>
	...
	<tr valign="top">
		<th scope="row"><label for="show_more"><span title="Read more testimonials link?">Display "Read more Support Messages" link?</span></label></th>
		<td><input name="show_more" type="checkbox" id="show_more" value="true" <?php echo $show_more_checked_state; ?> /></td>
	</tr>
	<tr valign="top">
		<th scope="row"><label for="show_more_link"><span title="Read more testimonials url">Read more Support Messages url</span></label></th>
		<td><input name="show_more_link" type="text" id="show_more_link" value='<?php echo $show_more_link; ?>' class="regular-text" /></td>
	</tr>
	<tr valign="top">
		<th scope="row"><label for="show_more_text"><span title="Read more testimonials text">Read more Support Messages text</span></label></th>
...
<table class="form-table">
	<tr valign="top">
		<th scope="row"><label for="max_page_testimonials"><span title="The maximum number of testimonials that should be displayed on the testimonials page.">Max Number Of Messages Displayed</span></label></th>
